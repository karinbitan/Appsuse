...
export default {
    template: `
    <section class="note-txt flex-column" v-bind:style="{backgroundColor: this.note.style.background}">
        ...
        <textarea name="txt" rows="5" placeholder="Take a note..."  v-model="txt" @change="reportVal" class="note-content"></textarea>
